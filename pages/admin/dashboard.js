          ...
          {loading ? (
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-4">
                <div className="mb-5  block   rounded-lg border border-gray-200  shadow-md m-5 p-5 col-span-2">
                  <p className="text-2xl font-semibold mb-3">Ventas</p>
                  <h3 className="text-6xl font-light mb-3">
                    ${summary.ordersPrice}{" "}
                  </h3>
                  <div className="text-xl hover:underline hover:underline-offset-4 w-fit">
